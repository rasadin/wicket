...
if( ! class_exists( 'Webalive_WooCommerce_Hooks' ) ) :

    class Webalive_WooCommerce_Hooks {
        ...
        /**
         * webalive WooCommerce Theme Support
         */
...
return new Webalive_WooCommerce_Hooks();
