...
/**
 * Class Name: Webalive_Nav_Walkers
...
class Webalive_Nav_Walkers extends Walker_Nav_Menu
{
    /**
		...
		public static function fallback( $args ) {
			if ( current_user_can( 'edit_theme_options' ) ) {
				...
				$fallback_output .= '>';
				$fallback_output .= '<li><a href="' . esc_url( admin_url( 'nav-menus.php' ) ) . '" title="' . esc_attr__( 'Add a menu', 'webalive' ) . '">' . esc_html__( 'Add a menu', 'webalive' ) . '</a></li>';
				$fallback_output .= '</ul>';
				if ( $container ) {
					$fallback_output .= '</' . esc_attr( $container ) . '>';
				}
